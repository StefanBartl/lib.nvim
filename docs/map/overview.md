...
**133 modules** · 25 namespaces · 133 helper files
...
|---|---|---|---|
| `lib.config` | User-facing configuration for lib.nvim. | 3 | [src](../../lua/lib/config/init.lua) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.lua.json.encode` | Pure-Lua JSON encoder — the counterpart to `lib.lua.json.decode`. | 7 | [src](../../lua/lib/lua/json/encode/init.lua) |
...
| &nbsp;&nbsp;`lib.nvim.autocmd` | ========================================================= Autocommand helper utilities. | 5 | [src](../../lua/lib/nvim/autocmd/init.lua) |
| &nbsp;&nbsp;`buf_win_tab` |  |  |  |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.buf_win_tab.normal_buffer` | Shared buffer/window primitives around "normal" file buffers. | 4 | [src](../../lua/lib/nvim/buf_win_tab/normal_buffer/init.lua) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.buf_win_tab.safe_adjacent_buffer` | Helper to force-save the last usable file buffer via :w! | 2 | [src](../../lua/lib/nvim/buf_win_tab/safe_adjacent_buffer/init.lua) |
...
| &nbsp;&nbsp;`lib.nvim.core` |  | 2 | [src](../../lua/lib/nvim/core/init.lua) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.cross.copy_to_clipboard` | Cross-platform clipboard write. | 1 | [src](../../lua/lib/nvim/cross/copy_to_clipboard/init.lua) |
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.cross.executable` | Executable lookup helpers: PATH resolution and Mason-managed binaries. | 4 | [src](../../lua/lib/nvim/cross/executable/init.lua) |
| &nbsp;&nbsp;&nbsp;&nbsp;`fs` |  |  |  |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.cross.fs.separators.collapse_dots` | Lexically collapse '.'/'..' segments and repeated separators in a path. | 6 | [src](../../lua/lib/nvim/cross/fs/separators/collapse_dots/init.lua) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.cross.open_default` | Open a path or URL with the system's default application — the cross-platform equivalent of double-clicking it in a file manager (extension/URL-scheme… | 2 | [src](../../lua/lib/nvim/cross/open_default/init.lua) |
| &nbsp;&nbsp;&nbsp;&nbsp;`platform` |  |  |  |
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.cross.run` | Shell selection and runners FIX: Optimize, doc | 4 | [src](../../lua/lib/nvim/cross/run/init.lua) |
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.cross.run_argv` | Low-level argv-based process runner with stdin support. | 2 | [src](../../lua/lib/nvim/cross/run_argv/init.lua) |
| &nbsp;&nbsp;&nbsp;&nbsp;`uv` |  |  |  |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.cross.uv.spawn_capture` | Async spawn of an argv command with buffered stdout/stderr capture and an optional timeout. | 1 | [src](../../lua/lib/nvim/cross/uv/spawn_capture/init.lua) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.docmap.browse` | `:LibBrowse` — the module map inside the editor. | 18 | [README](../../lua/lib/nvim/docmap/browse/README.md) · [src](../../lua/lib/nvim/docmap/browse/init.lua) |
| &nbsp;&nbsp;&nbsp;&nbsp;`docs` |  |  |  |
| &nbsp;&nbsp;&nbsp;&nbsp;`render` |  |  |  |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.fs.path` |  | 4 | [src](../../lua/lib/nvim/fs/path/init.lua) |
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.fs.path_shorten` | Utility module to shorten file paths for display. | 11 | [src](../../lua/lib/nvim/fs/path_shorten/init.lua) |
...
| &nbsp;&nbsp;`lib.nvim.git` | Git utility helpers for Neovim. | 12 | [src](../../lua/lib/nvim/git/init.lua) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`lib.nvim.notify.safe` | Provides helpers using vim.schedule, vim.defer_fn and vim.schedule_wrap to avoid calling vim.notify directly from contexts where it might cause issues (e.g.,… | 5 | [src](../../lua/lib/nvim/notify/safe/init.lua) |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`docs` |  |  |  |
...
| `lib.nvim_usrcmds` | Utility user commands that don't belong in a more specific plugin. | 8 | [src](../../lua/lib/nvim_usrcmds/init.lua) |
| `strategies` |  |  |  |
