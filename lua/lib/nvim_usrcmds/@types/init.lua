...
---@field helptags?           boolean  Regenerate helptags for all plugins after lazy.nvim installs/updates/syncs (NOT on every start -- see lib.nvim_usrcmds.autocmds.helptags) (default: true)
