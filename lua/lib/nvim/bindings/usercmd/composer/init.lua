...
local function make_handle(name, spec, root)
  ...
  function handle:check()
    return require("lib.nvim.bindings.usercmd.composer.check").results(root)
  end
...
function M.check_all()
  return require("lib.nvim.bindings.usercmd.composer.check").all()
end
...
function M.checkhealth(name_or_handle)
  return require("lib.nvim.bindings.usercmd.composer.check").checkhealth(name_or_handle)
end
...
function M.notify_check_all()
  return require("lib.nvim.bindings.usercmd.composer.check").notify_check_all()
end
