...
require("lib.nvim.autocmd.dispatcher.@types")

local M = {}

-- `lib.nvim.autocmd` itself eagerly pulls this module in (`M.dispatcher =
...
local function get_autocmd()
  return require("lib.nvim.autocmd")
end

M.filetype = require("lib.lua.lazy").require("lib.nvim.autocmd.dispatcher.filetype")
