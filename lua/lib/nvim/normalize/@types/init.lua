...
---@description
--- This module defines all type annotations for lib.nvim.normalize, providing comprehensive
...
---
---@field is_one_of fun(v: any, candidates: any[]): boolean
--- Check whether v equals one of candidates (plain ==, no coercion).
---
---@field buf_valid fun(bufnr: any): boolean
--- True when bufnr is a valid, currently-loaded buffer handle.
---
---@field win_valid fun(winid: any): boolean
