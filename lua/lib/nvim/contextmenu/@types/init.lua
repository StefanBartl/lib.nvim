...
---@field setup fun(opts?: { renderer?: Lib.ContextMenu.Renderer, native_popup?: boolean })  Sets `'mousemodel' = "extend"` by default, turning off Neovim's own built-in PopUp menu; `native_popup = true` opts back into it.
